...
$site_title = $page_title ?? 'My Account - Udyojika';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="dashboard-main">
        ...
        <header class="dashboard-topbar">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h5 class="font-serif fw-bold text-maroon-900 mb-0"><?php echo htmlspecialchars($page_header ?? 'Customer Portal'); ?></h5>
                    <small class="text-muted d-none d-md-inline"><?php echo htmlspecialchars($page_subheader ?? 'Manage your handmade orders, wishlist & delivery addresses'); ?></small>
                </div>
            </div>

            <div class="d-flex align-items-center gap-3">
                <a href="../index.php" class="btn btn-outline-maroon btn-sm d-none d-sm-inline-flex align-items-center gap-1" style="border-color: #7a1c28; color: #7a1c28;">
                ...
                <div class="dropdown">
                    <button class="btn d-flex align-items-center gap-2 p-1 text-decoration-none" type="button" data-bs-toggle="dropdown">
                        <img src="<?php echo htmlspecialchars($current_user['avatar'] ?? 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=300&auto=format&fit=crop'); ?>" class="rounded-circle" style="width: 36px; height: 36px; object-fit: cover;" alt="Profile">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 rounded-3 p-2">
                        <li><span class="dropdown-item-text small text-muted">Customer: <strong><?php echo htmlspecialchars($current_user['name']); ?></strong></span></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item small" href="orders.php"><i class="fa-solid fa-box me-2"></i> My Orders</a></li>
                        <li><a class="dropdown-item small" href="profile.php"><i class="fa-solid fa-gear me-2"></i> Profile Settings</a></li>
