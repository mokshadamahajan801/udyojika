...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
    ...
    <div class="btn-group shadow-sm bg-white p-1 rounded-3 border" role="group">
        ...
        <a
            href="orders.php?filter=all"
            class="btn btn-sm <?php echo $filter === 'all' ? 'btn-maroon' : 'btn-light'; ?>"
        >
            All (<?php echo count($seller_orders); ?>)
        </a>

        <a
            href="orders.php?filter=pending"
            class="btn btn-sm <?php echo $filter === 'pending' ? 'btn-maroon' : 'btn-light'; ?>"
        >
            Pending / New
        </a>

        <a
            href="orders.php?filter=processing"
            class="btn btn-sm <?php echo $filter === 'processing' ? 'btn-maroon' : 'btn-light'; ?>"
        >
            In Kitchen
        </a>

        <a
            href="orders.php?filter=completed"
            class="btn btn-sm <?php echo $filter === 'completed' ? 'btn-maroon' : 'btn-light'; ?>"
        >
            Completed
        </a>
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <?php foreach ($seller_orders as $ord):
                        ...
                        if (
                            $filter !== 'all' &&
                            $ord['order_status'] !== $filter
                        ) {
                            continue;
                        }

                        $my_earnings = array_sum(
                            array_column(
                                $ord['seller_items'],
                                'subtotal'
                            )
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <strong class="text-maroon-900 fs-6">
                                    ...
                                    ₹<?php
                                    echo number_format($my_earnings);
                                    ?>
                            ...
                            <td>
                                ...
                                <span
                                    class="badge-status-<?php echo htmlspecialchars($ord['order_status']); ?>"
                                >
                            ...
                            <td>
                                ...
                                <a
                                    href="order-details.php?id=<?php echo (int)$ord['id']; ?>"
                                    class="btn btn-sm btn-maroon fw-bold"
                                >
