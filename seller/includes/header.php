...
<div class="dashboard-wrapper">
    ...
    <div class="dashboard-main">
        ...
        <header class="dashboard-topbar">
            ...
            <div class="d-flex align-items-center gap-3">
                <a href="../business-details.php?id=<?php echo $seller_id; ?>" target="_blank" class="btn btn-outline-maroon btn-sm d-none d-sm-inline-flex align-items-center gap-1" style="border-color: #7a1c28; color: #7a1c28;">
                    <i class="fa-solid fa-arrow-up-right-from-square"></i>
                    <span>My Public Shop</span>
                </a>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 rounded-3 p-2" style="width: 280px;">
                        <li><h6 class="dropdown-header text-maroon-900 fw-bold">Recent Alerts</h6></li>
                        <li><a class="dropdown-item small py-2 rounded-2" href="orders.php"><i class="fa-solid fa-bag-shopping text-success me-2"></i> New Order for Bhajanichi Chakli</a></li>
                        <li><a class="dropdown-item small py-2 rounded-2" href="enquiries.php"><i class="fa-solid fa-comments text-primary me-2"></i> Bulk order enquiry from Priya</a></li>
                    </ul>
                </div>
                ...
                <div class="dropdown">
                    <button class="btn d-flex align-items-center gap-2 p-1 text-decoration-none" type="button" data-bs-toggle="dropdown">
                        <img src="<?php echo htmlspecialchars($seller_profile['avatar'] ?? $current_user['avatar']); ?>" class="rounded-circle" style="width: 36px; height: 36px; object-fit: cover;" alt="Profile">
                        <span class="d-none d-md-inline small fw-bold text-dark"><?php echo htmlspecialchars($seller_profile['owner_name']); ?></span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 rounded-3 p-2">
                        <li><span class="dropdown-item-text small text-muted">Maker: <strong><?php echo htmlspecialchars($seller_profile['business_name']); ?></strong></span></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item small" href="business.php"><i class="fa-solid fa-store me-2"></i> Edit Business Profile</a></li>
                        <li><a class="dropdown-item small" href="profile.php"><i class="fa-solid fa-gear me-2"></i> Account Settings</a></li>
