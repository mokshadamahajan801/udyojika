...
|--------------------------------------------------------------------------
|
| get_logged_in_user() only checks customer_id.
| Admin session will NOT affect the public website.
|
|--------------------------------------------------------------------------
*/
...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,600;0,700;0,800;1,400;1,600&family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&family=Rozha+One&display=swap"
        rel="stylesheet">
...
<header class="sticky-header">
    ...
    <div class="container py-3">
        ...
        <div class="row align-items-center g-3">
            ...
            <div class="col-6 col-lg-3 d-flex align-items-center gap-3">
                ...
                <a
                    ...
                    <div>
                        ...
                        <span
                            class="brand-font fs-3 fw-bold text-maroon-800 d-block lh-1">
            ...
            <div
                class="col-6 col-lg-4 order-2 order-lg-3 d-flex align-items-center justify-content-end gap-2 gap-sm-3">
                ...
                <!-- =================================================
                 CUSTOMER PROFILE - WHEN LOGGED IN
                ================================================== -->
                    ...
                    <div class="dropdown">
                        ...
                        <ul
                            ...
                            <li>
                                ...
                                <div
                                    class="px-3 py-2 border-bottom bg-light rounded-top">

                                    <strong
                                        class="d-block text-maroon-900 small">

                                        <?php
                                        echo htmlspecialchars($current_u['name'] ?? 'Customer');
                                        ?>
    ...
    <nav
        class="navbar navbar-expand-lg border-top py-1 d-none d-lg-block bg-white">

        <div class="container">

            <ul
                class="navbar-nav d-flex flex-row gap-4 align-items-center py-1">
...
<div
    ...
    <div class="offcanvas-body p-0">
        ...
        <div class="list-group list-group-flush">
            ...
            <!-- =================================================
             MOBILE CUSTOMER ACCOUNT - LOGGED IN
            ================================================== -->
